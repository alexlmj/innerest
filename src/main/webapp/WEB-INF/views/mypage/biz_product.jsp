...
function goPage(reqPage) {
	...
	location.href="/mypage/cor_product?reqPage="+reqPage+"&"+query;
}
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<h1 class="mypage-headline h3 text-gray-800">상품관리</h1>
              ...
              <div class = "d-flex flex-row-reverse">
                <div class="p-2 searchbar">
                  <form id="searchForm" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 right">
                      ...
                      <div class="input-group-append">
                        <button class="btn btn-primary" type="button" id="searchBtn">
                          <i class="fas fa-search fa-sm"></i>
							...
							<div class="d-flex flex-row-reverse write_button">
								<a href="/mypage/cor_product/reg">
									<button type="button" class="btn btn-secondary">상품등록</button>
								</a>
							</div><!-- *********************************************8ㅊㅊ -->
							<div class="table-overflow"> <!-- table-overflow로 전환 // table class "table-width" 추가 -->
									...
									<tbody>
										...
										<tr>
											...
											<td style="vertical-align: middle;">
												<p class="align-line">
													<img class="img-product" width="60px" height="60px" src="/file/display/${p.file_num1}">
												</p>
												<p class="align-line">
												<p class="order-name">${p.name }</p>
												<p id="option-select" class="order-option">
												<c:forEach items="${p.pdList}" var ="pd">
													옵션:${pd.pd_name} | <span id="option-price">+${pd.pd_price}</span>
												</c:forEach>	
												</p>
											</td>
											<td style="vertical-align: middle;">
											...
											<a href="/mypage/cor_product/edit?num=${p.num}"><span class="btn btn-sm btn-primary"> 수정하기</span></a>
											<span class=" btn-edit btn btn-sm btn-primary">삭제하기 </span>
											</td>
										</tr>
										</c:forEach>
									</tbody>
